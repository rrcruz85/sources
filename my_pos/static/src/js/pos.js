...
//            }
        ...
        getIvaCompensation: function() {
        	if (globalType) {
        		var pos_config = this.pos.get('pos_config');
        		//alert(this.pos.get('selectedOrder').getTotalTaxExcluded());
        ...
        exportAsJSON: function() {
            ...
            return {
                ...
                iva_compensation: this.pos.get('pos_config').iva_compensation
            };
        },
    ...
    module.Orderline = module.Orderline.extend({
    	export_as_JSON: function() {
            ...
            return {
                ...
                iva_compensation: this.get_unit_price() * pos_config.iva_compensation/100
            };
        },
    });
};
