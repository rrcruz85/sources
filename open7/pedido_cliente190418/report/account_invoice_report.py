...
class AccountInvoiceReport(report_rml):
    def create(self, cr, uid, ids, datas, context):
        ...
        for pedido in obj.browse(cr, uid, [datas.get('request_id', False)], context):
            ...
            #order by p.name, dl.box_id, v."name", dl.lengths, pp."name"
            ...
            for line in lines:
                ...
                #hb_cont =  qty_tmp if line[12] == 'HB' else 0
                #qb_cont =  qty_tmp if line[12] == 'QB' else 0
                ...
                rml += """
                        <blockTable colWidths="120.0,50.0,45.0,40.0,40.0,25.0,25.0,75.0,70.0,30.0,40.0" rowHeights="10.0" style="AllBorders">
                            <tr>
                                ...
                                #<td><para style="P5_COURIER_JUSTIFY">""" + (ustr(supplier if first and supplier else '')) + """</para></td>
