...
class OeMedicalNutritional(osv.osv):
    ...
    _columns={
                ...
                'eva_date': fields.date(string='Fecha de Evaluación', readonly=True),
                'fec_cir': fields.date(string='Fecha de Cirugía'),
                'cita': fields.integer(string='Cita'),
                'tip_dta': fields.text(string='Tipo de Dieta:'),
                'met_qur': fields.char(size=256, string='Método Quirúrjico :'),
                ...
                'des_hor': fields.char(string='Hora', size=5),
