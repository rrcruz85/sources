    ...
    def create(self, cr, uid, ids, datas, context):
        ...
        for bariatric in bariatric_obj.browse(cr, uid, ids, context):
            ...
            if bariatric.patient_id.marital_status:
                if bariatric.patient_id.marital_status == 's': marital_status = _('Single')
                if bariatric.patient_id.marital_status == 'm': marital_status = _('Married')
                if bariatric.patient_id.marital_status == 'w': marital_status = _('Widowed')
                if bariatric.patient_id.marital_status == 'd': marital_status = _('Divorced')
                if bariatric.patient_id.marital_status == 'x': marital_status = _('Separated')
                if bariatric.patient_id.marital_status == 'z': marital_status = _('Law marriage')
