...
{
    "name": "Oemedical Nutritional Evolution",
    "version": "1.0",
    "description": """
    ...
    "data":[
            "oemedical_nutritional_evolution_view.xml", #todos los archivos xml que posea nuestro modulo se debe de agregarse aqui
                ],
    "demo_xml": [
                        ],
    "update_xml": [
