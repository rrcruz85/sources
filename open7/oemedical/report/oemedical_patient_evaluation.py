        ...
        for evaluation in evaluation_obj.browse(cr, uid, ids, context):
            ...
            rml += """
                                <tr>
                                    ...
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.cardiopatia else '') + """</para></td>
                                    <td><para style="P23">2. Diabetes</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.diabetes else '') + """</para></td>
                                    <td><para style="P23">3. Enf. C. Vascular</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.enf_car else '') + """</para></td>
                                    <td><para style="P23">""" + tools.ustr('4. Hipertersión') + """</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.hipertension else '') + """</para></td>
                                    <td><para style="P23">""" + tools.ustr('5. Cáncer') + """</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.cancer else '') + """</para></td>
                                    <td><para style="P23">""" + tools.ustr('6. Tuberculosis') + """</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.tuberculosis else '') + """</para></td>
                                    <td><para style="P23">7. Enf. Mental</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.enf_men else '') + """</para></td>
                                    <td><para style="P23">8. Enf. Infecciosa</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.enf_inf else '') + """</para></td>
                                    <td><para style="P23">""" + tools.ustr('9. Malformación') + """</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.mal_for else '') + """</para></td>
                                    <td><para style="P23">10. Otro</para></td>
                                    <td><para style="P00_COURIER_CENTER">""" + ('X' if evaluation.patient_id.otra else '') + """</para></td>
                                </tr>"""
