...
#        return res
    ...
    _columns = {
        ...
        'active_component': fields.many2one('oemedical.medicament', string='Medicament'),
        'active_compon': fields.char('Medicamento', size=50),
        ...
        'qty' : fields.char(size=30, string='en letras'),
        'form': fields.char(string='Form', size=50, help='Drug form, such as tablet or gel'),
        'indications': fields.char(string='Indicaciones', size=50,),
    }
