...
class TestController(http.Controller):
    ...
    @http.route('/test_module', type='http', auth='user')
    def b(self, debug=False, **k):
        ...
        init =  """
                 ...
                 wc.show_application = function(){
                     wc.action_manager.do_action("test_module");
                 };
        ...
        html = request.registry.get('ir.ui.view').render(cr, session.uid,'test_module.index',{
            'modules': modules,
            'init': init,
        })
