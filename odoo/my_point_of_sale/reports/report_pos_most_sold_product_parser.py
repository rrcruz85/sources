...
class report_post_most_sold_product_parser(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        super(report_post_most_sold_product_parser, self).__init__(cr, uid, name, context=context)
        self.total = 0.0
        self.qty = 0.0
...
class report_post_most_sold_product_inherit(osv.AbstractModel):
    _name = 'report.my_point_of_sale.report_post_most_sold_product'
    _inherit = 'report.abstract_report'
    _template = 'my_point_of_sale.report_post_most_sold_product'
    _wrapped_report_class = report_post_most_sold_product_parser
