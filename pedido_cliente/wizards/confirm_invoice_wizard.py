        ...
        if pedido_id and supplier_id:
            ...
            if p_ids:
                ...
                for v in obj.line_ids:
                    if v.detalle_id and not v.detalle_id.confirmada:
                ...
                if not list_vals:
                    #raise osv.except_osv('Informacion',"Para el proveedor seleccionado ya todas las lineas han sido confirmadas.")
                    warning = {
                        'title': 'Informacion!',
