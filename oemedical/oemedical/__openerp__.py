...
##############################################################################
{
    ...
    'depends': ['base', 'sale', 'purchase', 'account', 'product', 'report_webkit', 'base_report_designer'],
    'application': True,
    'description': """
...
""",
    ...
    "data": [
        ...
        #'report/oemedical_patient_evalprint.xml', removed because it's not functional 
